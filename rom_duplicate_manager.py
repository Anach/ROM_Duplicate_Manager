...
from rom_duplicate_manager.config.settings import load_config, save_config, CONFIG_FILE
from rom_duplicate_manager.config.defaults import DEFAULT_FILE_TYPES, DEFAULT_LANGUAGE_PRIORITIES
from rom_duplicate_manager.utils.icons import get_icon_photo
from rom_duplicate_manager.utils.helpers import (
    normalize_filename, extract_version, extract_languages, get_partial_hash, format_size
)
from rom_duplicate_manager.ui.components import ToolTip, AutoScrollbar, create_tooltip
from rom_duplicate_manager.core.scanner import scan_folder
from rom_duplicate_manager.utils.updater import UpdateChecker, get_current_version

# Import all mixins
from rom_duplicate_manager.ui.themes import ThemeMixin
from rom_duplicate_manager.ui.menu_bar import MenuBarMixin
from rom_duplicate_manager.ui.file_list import FileListMixin
from rom_duplicate_manager.ui.dialogs import DialogMixin
from rom_duplicate_manager.core.duplicate_logic import DuplicateLogicMixin
